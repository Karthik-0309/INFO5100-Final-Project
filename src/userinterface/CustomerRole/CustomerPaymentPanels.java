...
public class CustomerPaymentPanels extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 280, 32));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(331, 74, 220, 30));

        FeedbackBtn.setBackground(new java.awt.Color(0, 204, 0));
        ...
        add(FeedbackBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 220, 60));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/payment_gif.gif"))); // NOI18N
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 60, 460, 510));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/payment_girl.gif"))); // NOI18N
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 90, -1, -1));
