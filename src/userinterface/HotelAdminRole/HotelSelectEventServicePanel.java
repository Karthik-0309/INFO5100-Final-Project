...
public class HotelSelectEventServicePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 370, -1, -1));
...
//        layout.next(userProcessContainer);
    ...
    private void placeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_placeButtonActionPerformed
        // TODO add your handling code here:
        Employee employee = ecosystem.getEmployeeDirectory().createEmployee("Akshay");
        UserAccount ua = ecosystem.getUserAccountDirectory().createUserAccount("akshay", "Sharan@77", employee, new CustomerRole(), "customerAdmin");
        Customer cust1 = ecosystem.getCustomerDirectory().createCustomer("akshay", ua, "1234567890", "abc", "akshayv0731@gmail.com","Boston");
...
//         setOrderListLegal(cust);
        ...
        CustomerPaymentPanels mm = new CustomerPaymentPanels(screen, cust1, Total, "We have received your order. We will update as soon as you have appointment is scheduled.");
