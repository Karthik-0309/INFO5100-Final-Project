...
cust1.setCardType("Credit");
               if(cust1.getCardType()!=""){
     
//         setOrderListLegal(cust);
          for(int i = 0; i < legalOrderDirectory.getOrderList().size(); i ++) {
            Total+= (Double.parseDouble(legalOrderDirectory.getOrderList().get(i).getPrice()));
        }
       CustomerPaymentPanels mm = new CustomerPaymentPanels(screen, cust1, Total, "We have received your order. We will update as soon as your have appointment is scheduled.");
