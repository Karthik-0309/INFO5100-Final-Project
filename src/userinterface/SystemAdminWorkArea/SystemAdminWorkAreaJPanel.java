...
//        root.insert(buses, 7);
    ...
    private void initComponents() {
        ...
        ManageCustomerButton.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/deliveryguy.gif"))); // NOI18N

        ManageDeliveryButton.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/200w (1).gif"))); // NOI18N

        EventBtn.setBackground(new java.awt.Color(0, 0, 0));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/regulation.jpg"))); // NOI18N

        LegalBtn.setBackground(new java.awt.Color(0, 0, 0));
        ...
        LegalBtn1.setBackground(new java.awt.Color(0, 0, 0));
